...
* Write a program that imports the variable a from the file variable_load_5.py and handles basics operations.
...
* Write the Python function def magic_calculation(a, b): that does exactly the same as the following Python bytecod:
