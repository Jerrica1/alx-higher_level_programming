...
What is map, reduce and map functtions
...
* Write a function that returns a new dictionary with all values multiplies by 2


### [10. Best score](,/9-best_score.py)
* Write a function that returns a key with the biggest integer value.


### [11. Multiply by using map](./11-multiply_list_map.py)
* Write a function that returns a list with all valuez multiplied by a number without using any loops.
...
### [13. Weighted avaerage](./100-weight_to_int.py)
